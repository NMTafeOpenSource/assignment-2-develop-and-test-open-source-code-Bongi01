...
namespace Car_Rental_Program
{
    public class Object : INotifyPropertyChanged
    {
        ...
        /// </summary>
        /// <typeparam vehicle="T"></typeparam>
        /// <param vehicle="backingField">Backing field of property</param>
        /// <param vehicle="value">Value to give backing field</param>
        /// <param vehicle="propertyName"></param>
        /// <returns></returns>
